...
export default () => {
	return (
		<div className="w-75 mx-auto" id="works-cited">
			<h1 className="text-center p-4">Works Cited</h1>
			<p className="text-start h4 p-3">
				Cascone, Sarah. “In Response to Pressure From Within, the
				Metropolitan Museum of Art Has Released an Institutionwide
				Equity and Diversity Plan.” Artnet News, Artnet News, 7 July
				2020,{" "}
				<u>
					<a
			...
			<p className="text-start h4 p-3">
				Weiss, Daniel H., and Max Hollein. “Our Commitments to
				Anti-Racism, Diversity, and a Stronger Community Daniel H.
				Weiss.” Metmuseum.org, 6 July 2020,{" "}
				<u>
					<a
