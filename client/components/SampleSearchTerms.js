...
const SampleSearchTerms = () => (
  <ul>
    ...
    <li className='list-group-item'>Tag: Angel, Highlighted Works Only</li>
    <li className='list-group-item'>Tag: Flower, Female Artists Only</li>
  </ul>
);

export default SampleSearchTerms;
