        ...
        <Controller>
          <Scene duration={1000} triggerHook={0.1} pin={true}>
            <p className="text-center mt-2 mb-3 mx-auto my-auto">
              ...
              representation of male and western artists, compared to female and
              non-western artists. The Met’s digital collection contains over
              375,000 pieces of artwork available through the Open Access
              program. We created two sets of contrasting art works to highlight
              the overt bias in the Met's Collection, one depicting women by
              women artists, juxtaposed with nude paintings of women by male
              artists, while the other queried the Met's "highlighted" works and
              contrasted American pieces with pieces from underrepresented
              countries. The art we are presenting comes in the form of
              live-motion voronoi diagrams, allowing us to present multiple
              views and elements from many different artworks. Voronoi diagrams
              are created by mapping the relationships between data, which
              seemed metaphoric for our demonstration. In 2019, The Met was the
              3rd most visited art museum in the world, with nearly 7,000,000
              visitors annually, and was the most visited art museum in America.
              What responsibility does the most prominent art museum in the
              country have to highlight diverse and underrepresented artists and
              their cultures? How can we demand accountability from historically
              biased institutions, if we can't observe the current dismal state
              of affairs?
            </p>
          </Scene>
          {/* CANVAS1 */}
            ...
            {(progress) => (
              <div>
                <Timeline totalProgress={progress} paused>
                  ...
                  <Timeline
                    target={
                      <h1 className="animate animation1">
                        These 17 pieces are the only oil paintings available by
                        women, featuring women via the MET API.
                        <br /> <br />
          ...
          <Scene duration={"100%"} triggerHook={0.2} pin={true}>
            <Timeline
              target={
                <p className="text-center mt-2 mb-3 mx-auto my-auto">
                  This Voronoi consists of art by women with at least one woman
                  subject. Originally, the plan was to only use works
                  highlighted by The Met, but there were only 3. I decided to
                  limit my selection to just oil paintings in order to create a
                  cohesive look.
                </p>
              }
            >
            ...
            <Timeline
              target={
                <p className="text-center mx-auto my-auto">
                  This voronoi combined all of the artwork from the previous two
                  to show a more balanced view of artwork depicting women from
            ...
            <Timeline
              target={
                <p className="text-center mx-auto my-auto">
                  ...
                  The paintings included in this voronoi were the result of a
                  simple query into the Met's highlighted works and contained
                  the parameter "Location: New York." It yielded over 50
                  results, resulting in more complex voronoi than its
                  underrepresented counterpart. Details that are noteworthy
                  include the stark lack of people of color (BIPOC) as subjects,
                  and the fact that only three paintings are by women artists
                  (two of which are by the same woman).
                </p>
              }
            >
              <Tween from={{ opacity: 0 }} to={{ opacity: 1 }} />
            ...
            {(progress) => (
              <div>
                <Timeline totalProgress={progress} paused>
                  ...
                  <Timeline
                    target={
                      <h1 className="animate animation5">
                        The Met has 107 pieces of highlighted work <br /> from
                        NY (population 19 million ), but <br /> only 177 from
                        all of Africa (population 1.35 billion).
                      </h1>
                    }
                  >
                    <Tween
            ...
            <Timeline
              target={
                <p className="text-center mx-auto my-auto">
                  ...
                  and major European countries, this piece shows art from
                  ...
                  1 from Korea, 3 from Japan, to name only a few. There are 3
                  from all of Africa. These images all come from countries that
                  are largely underrepresented in the chosen “highlights” of the
                  Met, but also in the collection at large. Most are from Middle
                  Eastern or Eastern countries.
                </p>
              }
            >
              <Tween from={{ opacity: 0 }} to={{ opacity: 1 }} />
